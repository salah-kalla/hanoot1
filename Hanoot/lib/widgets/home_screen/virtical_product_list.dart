...
class Virtical_Product_List extends StatelessWidget {
   int categoryId ;
  ...
  Widget build(BuildContext context) {
    return  ChangeNotifierProvider<ProductListState>(
        create: (context) => ProductListState(categoryId:20 ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      child: Row(
                        ...
                        children: <Widget>[
                          Text("مكياج",style:GoogleFonts.elMessiri(fontSize: 20)),
                          InkWell(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (_)=> ProductListCategory(categoryId:20,),
