...
import 'package:Hanoot/states/homescreen/cards_state.dart';
...
class Cards extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<CardState>(builder: (context, state, child) {
      return Column(
        children: <Widget>[
          Padding(
            ...
            child: Container(
              child: Row(
                ...
                children: <Widget>[
                  Text("كروت الدفع المسبق",style:GoogleFonts.elMessiri(fontSize: 20)),
                  InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (_)=> ProductListCategory(categoryId:193,isSeen: true,),
