...
class Vegetables extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<VegetablesState>(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Container(
                  child: Row(
                    ...
                    children: <Widget>[
                      Text("الخضار والفواكه",style:GoogleFonts.elMessiri(fontSize: 20)),
                      InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (_)=> ProductListCategory(categoryId:145,isSeen: true,),
              ...
              state.isLoading
               ?Container(
                  ...
                  child:
                  ShimmerProduct(horizontal: true,))
                  ...
                  itemBuilder: (context,index){
                    return Container(
                        ...
                        child: ProductDisplayCard(onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (_)=>DetailProducts(product:state.products[index],fromHome: true,),
                              fullscreenDialog: true
                          ));
                        },
