...
import 'package:Hanoot/states/homescreen/colthes_state.dart';
...
class Colthes extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer<ColthesState>(
              ...
              Padding(
                ...
                child: Container(
                  child: Row(
                    ...
                    children: <Widget>[
                      Text("ملابس",style:GoogleFonts.elMessiri(fontSize: 20)),
                      InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (_)=> ProductListCategory(categoryId:126,isSeen: true,),
