...
import 'package:Hanoot/states/homescreen/beauty_state.dart';
...
class Beauty extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<BeautyState>(builder: (context, state, child) {
      return Column(
        children: <Widget>[
          Padding(
            padding:
            ...
            child: Container(
              child: Row(
                ...
                children: <Widget>[
                  Text("جمال", style: GoogleFonts.elMessiri(fontSize: 20)),
                  InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
