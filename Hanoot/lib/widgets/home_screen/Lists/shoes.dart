...
import 'package:Hanoot/states/homescreen/shoes_state.dart';
              ...
              Padding(
                ...
                child: Container(
                  child: Row(
                    ...
                    children: <Widget>[
                      Text("أحذية",style:GoogleFonts.elMessiri(fontSize: 20)),
                      InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (_)=> ProductListCategory(categoryId:128,isSeen: true,),
