...
import 'package:Hanoot/states/homescreen/men_state.dart';
              ...
              Padding(
                ...
                child: Container(
                  child: Row(
                    ...
                    children: <Widget>[
                      Text("رجال",style:GoogleFonts.elMessiri(fontSize: 20)),
                      InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (_)=> ProductListCategory(categoryId:24,isSeen: true,),
